...
# parking lot. carType can be of three kinds:
# big, medium, or small, which are represented by 1, 2, and 3 respectively. A car can only park in a parking space of
# its carType. If there is no space available,
...
class ParkingSystem:
    ...
    def add_car(self, car_type: int) -> bool:
        self.A[car_type -1] -= 1
        return self.A[car_type - 1] >=0


parkingSystem = ParkingSystem(1, 1, 0);
print(parkingSystem.A)
print(parkingSystem.add_car(1))
print(parkingSystem.A)
print(parkingSystem.add_car(2))
print(parkingSystem.A)
print(parkingSystem.add_car(3))
print(parkingSystem.A)
print(parkingSystem.add_car(1))
